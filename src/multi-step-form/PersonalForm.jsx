            ...
            <div className="mt-3 sm:mt-7 ml-3 sm:ml-0">
              <div className=" sm:flex justify-between gap-2 mb-7">
                ...
                <div
                  ...
                  } border-[1.5px] rounded-md p-3 sm:w-24 hover:cursor-pointer hover:border-multiForm-Marineblue w-full flex gap-4 items-center sm:block h-20 sm:h-auto`}
                ...
                >
                  ...
                  <div className="sm:mt-7">
                    ...
                    {planType == 0 ? (
                      ...
                      <>
                        <p className="text-multiForm-Coolgray text-sm">
                          $90/yr
                        </p>
                        <p className="font-semibold text-multiForm-Marineblue text-sm">
                          2 months free
                        </p>
                      </>
                    )}
                ...
                <div
                  className={` ${
                    plan === "Advanced"
                      ? "bg-blue-100 border-multiForm-Purplishblue"
                      : "border-multiForm-Lightgray bg-transparent"
                  } border-[1.5px] rounded-md p-3 sm:w-24 hover:cursor-pointer hover:border-multiForm-Marineblue w-full flex gap-4 items-center sm:block my-3 sm:my-0 h-20 sm:h-auto`}
              ...
              <div>
                <div className="bg-white left-0 right-0 h-24 absolute bottom-0 sm:static sm:bg-transparent ">
                  ...
                  >
                    <p className="text-xs text-multiForm-Coolgray">Go Back</p>
                  </button>
                  <button
                    type="submit"
                    className="bg-multiForm-Marineblue absolute  bottom-5 right-10 sm:right-16 mt-4 px-4 py-3 rounded-md flex place-self-end hover:bg-multiForm-Purplishblue"
